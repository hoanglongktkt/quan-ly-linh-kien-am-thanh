...
/**
 * Search list đơn: $eq (tận dụng index khi nhập đủ mã) + $regex contains (substring).
 * Ví dụ tracking `SPXVN066929466519` khớp từ khóa `66519`.
 */
